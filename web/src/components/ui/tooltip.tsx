...
function TooltipContent({
  ...
  > & {
    /**
     * The pointer at the trigger. Worth dropping for a tooltip on a small
     * target inside a dense list, where the arrow lands on a neighbour and
     * reads as a stray mark. Defaults on, so existing call sites are unchanged.
     */
    showArrow?: boolean;
  }) {
  return (
