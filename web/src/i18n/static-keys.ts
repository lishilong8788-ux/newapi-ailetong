...
export const STATIC_I18N_KEYS = [
  ...
  // Invoice status / type labels and messages (feature constants)
  'Pending',
  'Pending Issue',
  'Pending Invoicing',
  'Processing',
  ...
  // Invoicing notice bullets (feature constants)
  ...
  // Invoice success / error messages (feature constants)
  'Invoice profile created successfully',
  'Invoice profile updated successfully',
  'Invoice profile deleted successfully',
  'Default invoice profile updated',
  'Invoice request submitted successfully',
  'Invoice request cancelled successfully',
  'Invoice issued successfully',
  'Invoice request rejected',
  'Marked as processing',
  'Invoice email resent',
  'Pending invoice list exported',
  'Failed to load invoices',
  'Failed to load invoice profiles',
  'Failed to load invoiceable orders',
  'Failed to load invoice requests',
  'Failed to load invoice request detail',
  'Failed to save invoice profile',
  'Failed to delete invoice profile',
  'Failed to submit invoice request',
  'Failed to cancel invoice request',
  'Failed to issue invoice',
  'Failed to reject invoice request',
  'Failed to mark invoice request as processing',
  'Failed to resend the invoice email',
  'Failed to export the pending invoice list',
  'Invoice number is required',
  'PDF link must be a public http or https address, not an IP or a bare name',
  'Upload the invoice file, or fill in a PDF link',
  'Failed to upload the attachment',
  'Failed to remove the attachment',
  'Each attachment must be under {{max}} MB',
  'Attachments must total under {{max}} MB so the email can carry them',
  'Only PDF, OFD, JPG and PNG files are accepted',
  'Attachment uploaded',
  'Attachment removed',
